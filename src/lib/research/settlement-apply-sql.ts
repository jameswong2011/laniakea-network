/** Pays hunt/ascent in the database. Same weights as settlement.ts. Safe to re-run. */
export const SETTLEMENT_APPLY_SQL = `-- Apply hunt / ascent bounties inside Postgres so RLS cannot block credits.
